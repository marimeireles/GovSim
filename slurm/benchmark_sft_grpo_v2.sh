#!/bin/bash
#SBATCH --job-name=govsim-eval-v4
#SBATCH --account=def-zhijing
#SBATCH --time=24:00:00
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=8
#SBATCH --mem=64G
#SBATCH --output=slurm/logs/benchmark_sft_grpo_v2_%j.out
#SBATCH --error=slurm/logs/benchmark_sft_grpo_v2_%j.err

# ============================================================
# GovSim Benchmark: SFT+GRPO v2 fine-tuned gemma3-4b-it
# ============================================================

set -eo pipefail

SFT_MERGED="${SFT_MERGED:-models/gemma3-4b-sft-v2-merged}"
GRPO_ADAPTER="${GRPO_ADAPTER:-models/gemma3-4b-sft-grpo-v2/final_adapter}"
FINAL_MERGED="${FINAL_MERGED:-models/gemma3-4b-sft-grpo-v2-merged}"
GROUP_NAME="${GROUP_NAME:-gemma3-4b-sft-grpo-v2}"
SEED="${SEED:-42}"

echo "============================================================"
echo "Job:         GovSim SFT+GRPO v2 Benchmark"
